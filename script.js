// Code smell: variabel yang tdk digunakan
let unusedVariable = "Saya tidak dipakai"; // CODE SMELL
...
// Code smell: kondisi if selalu true
if (true) { // CODE SMELL
    let debugMessage = "Blok ini selalu dieksekusi meskipun tidak dibutuhkan";
    // Tapi isi blok tidak melakukan apa-apa
}
